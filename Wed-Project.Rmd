...
plot(x = seq(from = 0, to = 5, length.out = 4), y = seq(from = 0, to = 3.5, length.out = 4), xaxt = "n", type = "n", ylab = expression(paste(italic(alpha))), las = 1, xlab = expression(paste(italic("q"))))
...
plot(x = seq(from = 0, to = 5, length.out = 4), y = seq(from = 0, to = 6, length.out = 4), xaxt = "n", type = "n", ylab = expression(paste(italic(alpha))), las = 1, xlab = expression(paste(italic("q"))))
axis(1, at = c(0, 1, 2, 3, 4, 5))
# populate the plot
for(i in 1:6){
